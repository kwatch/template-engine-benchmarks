...
//
// NOTE: This file was generated from: japidviews/stocks.html
// Change to this file will be lost next time the template file is compiled.
//
public class stocks extends cn.bran.japid.template.JapidTemplateBaseWithoutPlay
{	public static final String sourceTemplate = "japidviews/stocks.html";
	public stocks() {
		super(null);
	}
	public stocks(StringBuilder out) {
		super(out);
	}
/* based on https://github.com/branaway/Japid/issues/12
 */
public static final String[] argNames = new String[] {/* args of the template*/"items",  };
public static final String[] argTypes = new String[] {/* arg types of the template*/"java.util.List<Stock>",  };
public static final Object[] argDefaults= new Object[] {null, };
public static java.lang.reflect.Method renderMethod = getRenderMethod(japidviews.stocks.class);
...
////// end of named args stuff
	...
	public String render(java.util.List<Stock> items) {
		this.items = items;
		long t = -1;
		try {super.layout();} catch (RuntimeException e) { super.handleException(e);}
		 if (t != -1) System.out.println("[stocks] rendering time: " + t);
